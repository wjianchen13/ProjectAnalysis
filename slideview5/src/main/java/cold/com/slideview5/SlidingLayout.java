...
public class SlidingLayout extends FrameLayout implements ISlide {
    ...
    public SlidingLayout(Context context, AttributeSet attrs)  {
        ...
        controlViewId = ta.getString(R.styleable.viewid_control);
...
//                        0 + lp.leftMargin + lp.rightMargin,
//                        lp.width);
...
//                mDrawerView.layout(childLeft, lp.topMargin, childLeft + menuWidth,
//                        lp.topMargin + mDrawerView.getMeasuredHeight());
//            } else {
...
//        }
    ...
    protected void onFinishInflate() {
        ...
        mControlView = (Button)findViewById(getResources().getIdentifier(controlViewId, "id", mContext.getPackageName()));
        if(mControlView == null) {
            throw new IllegalArgumentException("mControlView is null ");
        }
