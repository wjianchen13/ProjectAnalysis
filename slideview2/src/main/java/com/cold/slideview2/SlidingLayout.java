 ...
 * 17-07-17 10:00 由于侧边栏控制事件是在它的子控件SlideContentLayout里面实现的，所以需要在return mHelper.shouldInterceptTouchEvent(ev);里面进行控制，不然ziview就会把事件消费掉
 */
public class SlidingLayout extends RelativeLayout implements ISlide
{
    /**
     * 滑动速率，每秒dip
     */
    ...
    protected void onFinishInflate() {
        ...
        if (getChildCount() != 2) {
            throw new IllegalArgumentException("this view only contains 3 children! ");
        } else {
...
//            mContentView = new MyFrameLayout(mContext);
