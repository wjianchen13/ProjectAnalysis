 ...
 * 注释掉了onViewPositionChanged，增加了newLeft，实现侧滑不随手势移动弹出
 */
public class SlidingLayout_bak2 extends FrameLayout implements ISlide {
...
//            float offset = (childWidth - releasedChild.getLeft()) * 1.0f / childWidth;
    ...
    public SlidingLayout_bak2(Context context, AttributeSet attrs)  {
        super(context, attrs);
