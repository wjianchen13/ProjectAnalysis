...
import com.cold.marquee.other.WSBaseBroatcastBean;
import com.cold.marquee.other.WSChater;
...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("---------------------------> test1 x: " + test1.getMyX());
...
//        String test1 = "恭喜 “꧁༺涛༒哥༻꧂” 成为 “骚骚莲骚骚” 的骑士";
    ...
    public void test1(View v) {
        test1.setTextAndGravity("测试123456哈哈哈啊啊啊啊啊啊啊啊大是大非大沙发是的发送到饭店撒旦");
        test1.setGravity(Gravity.CENTER_VERTICAL);
        System.out.println("============================> test1 x2: " + test1.getMyX());
        test1.setText("测试123456哈哈哈啊啊啊啊啊啊啊啊大是大非大沙发是的发送到饭店撒旦");
        test1.reset();
        test1.resumeScroll();
    }
    ...
    public void test2(View v) {
        if(test1.getScrollerState()) {
            test1.finishScroller();
        }
        test1.setTextAndGravity("你好");
        test1.setGravity(Gravity.CENTER);
        System.out.println("============================> test1 x1: " + test1.getMyX());
        test1.setText("你好");
    }
