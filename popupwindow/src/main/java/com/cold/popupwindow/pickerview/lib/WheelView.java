package com.cold.popupwindow.pickerview.lib;
...
import com.cold.popupwindow.R;
import com.cold.popupwindow.pickerview.listener.OnItemSelectedListener;
import com.cold.popupwindow.pickerview.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if(attrs != null) {
            ...
            itemsVisible = a.getInteger(R.styleable.wheelview_itemsVisible, itemsVisible);
        }
